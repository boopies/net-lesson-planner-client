            ...
            <form className='create-lesson' id='create-lesson-form-confirm'
                onSubmit={this.props.handleSubmitForm}>
                        <ul className='create-confirmation'>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Lesson Title</h4>
                                    <p>{values.title}</p>
                            </li>
                            <li className='confirm__li'>
                            <h4 className='confirm__h4'>Date</h4>
                                    <p>{values.date}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Day</h4>
                                    <p>{values.day}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Duration</h4>
                                    <p>{values.duration}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Year Level</h4>
                                    <p>{values.classlevel}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Period</h4>
                                    <p>{values.period}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Topic</h4>
                                    <p>{values.topic}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Goals</h4>
                                    <p>{values.goal}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Objective One</h4>
                                    <p>{values.objective_one}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Objective Two</h4>
                                    <p>{values.objective_two}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Objective Three</h4>
                                    <p>{values.objective_three}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Materials</h4>
                                    <p>{values.materials}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Warmup Activity</h4>
                                    <p>{this.renderActivityName(values.warmup_id)}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Presentation Activity One</h4>
                                    <p>{this.renderActivityName(values.presentation_one_id)}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Presentation Activity Two</h4>
                                    <p>{this.renderActivityName(values.presentation_two_id)}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Practice Activity One</h4>
                                    <p>{this.renderActivityName(values.practice_one_id)}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Practice Activity Two</h4>
                                    <p>{this.renderActivityName(values.practice_two_id)}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Practice Activity Three</h4>
                                    <p>{this.renderActivityName(values.practice_three_id)}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Production Activity One</h4>
                                    <p>{this.renderActivityName(values.product_one_id)}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Production Activity Two</h4>
                                    <p>{this.renderActivityName(values.product_two_id)}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>CooldownActivity</h4>
                                    <p>{this.renderActivityName(values.cooldown_id)}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Reflection One</h4>
                                    <p>{values.reflection_one}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Reflection Two</h4>
                                    <p>{values.reflection_two}</p>
                            </li>
                            <li className='confirm__li'>
                                    <h4 className='confirm__h4'>Reflection Three</h4>
