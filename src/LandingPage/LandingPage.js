        ...
        return (
            ...
            <section className='landing-page___description'>
                ...
                <div className='landing-page_info'>
                    <div className='landing-page___introduction'>&emsp;&emsp;Welcome to N.E.T Lesson Planner. This app was designed to get you up and running
                    ...
                    <div className={currentUser.id === 0 ? 'landing-page___introduction' : 'landing-page___introduction  hidden'}>
                    &emsp;&emsp;Free users can create lessons and read activities. However please register for a full account if you want to add activities, and saved your lessons.
                    <br />
                    &emsp;&emsp;If you want to trial all the areas that the full users can access, please use this demo account.
                    ...
                    &emsp;&emsp;If you like what you see, and want to add to the list of activities, or have your lessons saved, please join.
                    </div>
